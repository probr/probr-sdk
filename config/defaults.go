...
func setFromEnvOrDefaults(e *VarsObject) {
...
// set fetches the env var or sets the default value as needed for the specified field from VarsObject
func (e *VarsObject) set(field interface{}, varName string, defaultValue interface{}) {
	switch v := field.(type) {
	default:
