...
func setFromEnvOrDefaults(e *Vars) {
...
// set fetches the env var or sets the default value as needed for the specified field from Vars
func (e *Vars) set(field interface{}, varName string, defaultValue interface{}) {
	switch v := field.(type) {
	default:
